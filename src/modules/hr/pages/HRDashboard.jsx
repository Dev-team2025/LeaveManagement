...
function HRDashboard() {
  ...
  useEffect(() => {
    ...
    const loadDashboard = async () => {
      const response = await hrService.getDashboard(axiosInstance)
  ...
  if (isLoading) {
    return <Loader label="Loading HR overview" />
  }
  ...
  return (
    <section className="space-y-6">
      <div>
        ...
        <h1 className="mt-2 font-display text-4xl font-semibold text-ink-900">Organization leave pulse</h1>
      </div>
